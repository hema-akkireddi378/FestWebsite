export default function Privacy() {
    return (
        <div className='privacy'>
            ...
            <p className='privacyPolicy-mainContent'>When you use our services, you’re trusting us with your information. We understand this is a big responsibility and work hard to protect your information and put you in control. Lorem ipsum dolor sit amet consectetur, adipisicing elit. Eos ut dicta cupiditate quasi exercitationem modi! Libero adipisci, ratione optio itaque aut eaque asperiores, odio perferendis, quos a ex expedita vitae.</p>
            <p className='privacyPolicy-mainContent'>Welcome to [Your Fest Name], hosted by [Your College Name]. Your privacy is important to us. This Privacy Policy explains how we collect, use, and protect your personal information when you visit our website [Your Website URL]. Lorem ipsum dolor, sit amet consectetur adipisicing elit. Sint ad, mollitia, perferendis provident eius numquam architecto expedita, ipsa minima corporis qui nesciunt sed iste maiores ea quibusdam. Obcaecati, debitis quasi.</p>
