                    ...
                    <nav className="footernav">
                        <ul className="footerul">
                            <div className="admin-list">
                                <li className="admin-list-header"><h2>Admin Panel</h2></li>
                            ...
                            <div className="gamification">
                                <li className="gamification-header"><h2>Gamification</h2></li>
                            ...
                            <div className="gallery">
                                <li className="gallery-header"><h2>Gallery & Sponsers</h2></li>
                            ...
                            <div className="support">
                                <li className="support-header"><h2>Support & Accessibility</h2></li>
                            ...
                            <div className="post-fest">
                                <li className="post-fest-header"><h2>Post-Fest</h2></li>
